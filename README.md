...
Desenvolvedor apaixonado pela engenharia de software em geral, seja Web (front e back), Mobile, Embarcados, etc. Atualmente, no âmbito profissional, estou com foco em Desenvolvimento Web mais voltado para back-end com aplicações escaláveis de protocolos de autenticação e autorização.

Quer trocar uma ideia? Entre em contato! Será um prazer falar com você!
...
Compilado de todas as tecnologias com que já trabalhei ou estudei.
